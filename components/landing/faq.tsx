...
const faqs = [
  {
    ...
    answer: (
      <>
        Yes, this template is completely free and <a href={SITE.GITHUB_REPO_URL} target="_blank">open source</a>! You can use it for both personal and commercial projects without any licensing fees. You can fork, copy, modify, and distribute it as you see fit without any restrictions and attribution.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="mt-2">The deployment process is fully documented in the <a href={`${SITE.GITHUB_REPO_URL}/blob/main/README.md`} target="_blank">GitHub repository</a>.</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p>You can also check out the <a href={`${SITE.GITHUB_REPO_URL}/blob/main/README.md`} target="_blank">documentation</a> for more information.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        Contributions are welcome! Feel free to open issues, submit pull requests, or help improve the documentation on <a href={SITE.GITHUB_REPO_URL} target="_blank">GitHub</a>. The project follows standard open source contribution guidelines.
      </>
    ),
  },
];
